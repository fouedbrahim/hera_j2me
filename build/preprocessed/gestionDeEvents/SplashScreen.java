...
public class SplashScreen extends Canvas implements Runnable {
    ...
    private ProjectMIDlet projectMIDlet;
     private MidletAjout MidletAjout;
    ...
    public SplashScreen(ProjectMIDlet projectMIDlet){
        ...
        try{
        mImage = Image.createImage("gestionDeEvents/images/splash.jpg");
    ...
    public SplashScreen(MidletAjout MidletAjout){
        this.MidletAjout = MidletAjout;
        try{
        mImage = Image.createImage("gestionDeEvents/images/splash.jpg");
        Thread t = new Thread(this);
        t.start();
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new Form("Proposer un evennemet"));
